                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'airport.id.label', default: 'Id')}" />
                    ...
                    <g:each in="${airportInstanceList}" status="i" var="airportInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${airportInstance.id}">${fieldValue(bean: airportInstance, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: airportInstance, field: "name")}</td>
